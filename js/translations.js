...
const translations = {
    en: {
        ...
        'onboarding.step1.templateBtn': '📋 Create Your Spreadsheet from Template',
        ...
        'onboarding.step1.placeholder': 'Paste Spreadsheet ID or full Google Sheets URL',
        'onboarding.step1.help': 'You can paste either the full Google Sheets URL or just the Spreadsheet ID — both work',  
    ...
    ro: {
        ...
        'onboarding.step1.templateBtn': '📋 Creează Spreadsheet-ul din Șablon',
        ...
        'onboarding.step1.placeholder': 'Lipiți ID-ul sau URL-ul complet Google Sheets',
        'onboarding.step1.help': 'Puteți lipi fie URL-ul complet Google Sheets, fie doar ID-ul Spreadsheet-ului — ambele funcționează',  
